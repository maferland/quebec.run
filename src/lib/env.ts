...
const envSchema = z.object({
  ...
  USE_RESEND: z.string().transform((val) => val === "true").default("true"),
  ...
  {
    message: "If USE_RESEND=true, RESEND_API_KEY is required. If USE_RESEND=false, EMAIL_SERVER_HOST and EMAIL_SERVER_PORT are required.",
    path: ["email_config"]
  }
)
